#' @title Column Centering and Scaling
#' @description This function is a fast way to scale columns of a matrix
#' @param x numeric matrix
#' @param center Should the columns be centered
#' @param scale Should the columns be scaled
